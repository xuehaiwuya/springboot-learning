...
import com.studyinghome.business.common.SecurityConst;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) {
        //过滤不需要登录的请求
        web.ignoring().antMatchers(SecurityConst.AUTH, SecurityConst.SWAGGER);
    }
...
//        configurePermitAll(http);
    ...
    private void configureSecurity(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .loginPage(SecurityConst.AUTH)
                .loginProcessingUrl(SecurityConst.LOGIN)
                //登录请求时的用户名和密码字段
                .usernameParameter(RedisConst.USERNAME).passwordParameter(RedisConst.PASSWORD)
